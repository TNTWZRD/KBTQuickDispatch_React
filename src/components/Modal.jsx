  ...
  return (
    <div className="top-3 right-3 left-3 bottom-3" style={{'position': 'absolute'}} onClick={onClose}>
      ...
      <div className="modal-container fixed inset-0 flex items-center justify-center">
        <div className="modal-content bg-gray-100 rounded-lg shadow-lg p-6 w-full max-w-2xl mx-2 md:mx-5 md:h-9/10 md: mb-15 h-screen overflow-auto" onClick={(e) => e.stopPropagation()}>
